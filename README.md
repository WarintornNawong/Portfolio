...
- [Command Audio Classification](https://github.com/WarintornNawong/Portfolio/tree/main/Command%20Audio%20Classification) : Predict the Command by Recognizing the audio from speech command dataset i.e. Up, Down, Left, Right etc. with Deep Neural Network.
